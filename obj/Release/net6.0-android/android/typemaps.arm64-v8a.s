...
map_modules:
	...
	.byte	0x51, 0x1, 0x46, 0x78, 0xbf, 0xd9, 0xcf, 0x47, 0x85, 0xcd, 0x90, 0x7d, 0x24, 0x5c, 0xa4, 0x41	// module_uuid: 78460151-d9bf-47cf-85cd-907d245ca441
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module9_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.9	// assembly_name: applicationRencontre
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
...
map_java:
	...
	.word	0x2000010	// type_token_id
	.ascii	"crc64b81b0f3d8a619926/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x9	// module_index
	.word	0x2000011	// type_token_id
	.ascii	"crc64b81b0f3d8a619926/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
